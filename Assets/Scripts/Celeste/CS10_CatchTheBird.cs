...
namespace Celeste
{
    public class CS10_CatchTheBird : CutsceneEntity
    {
        ...
        private IEnumerator Cutscene(Level level)
        {
            ...
            yield return Textbox.Say("CH9_CATCH_THE_BIRD", cs10CatchTheBird.BirdLooksHurt, cs10CatchTheBird.BirdSquakOnGround, cs10CatchTheBird.ApproachBird, cs10CatchTheBird.ApproachBirdAgain, cs10CatchTheBird.BadelineAppears, cs10CatchTheBird.WaitABeat, cs10CatchTheBird.MadelineSits, cs10CatchTheBird.BadelineHugs, cs10CatchTheBird.StandUp, cs10CatchTheBird.ShiftCameraToBird);
