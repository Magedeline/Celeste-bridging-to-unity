...
namespace Celeste
{
    public class CS10_Farewell : CutsceneEntity
    {
        ...
        private IEnumerator Cutscene(Level level)
        {
            ...
            FadeWipe fadeWipe = new FadeWipe(cs10Farewell.Level, true);
            ...
            while (!cs10Farewell.player.OnGround() || cs10Farewell.player.Speed.Y < 0.0)
            {
                ...
                cs10Farewell.player.Speed.Y += (float) (Engine.DeltaTime * 900.0 * 0.20000000298023224);
            ...
            yield return 0.8f;
            yield return Textbox.Say("CH9_FAREWELL", cs10Farewell.Laugh, cs10Farewell.StopLaughing, cs10Farewell.StepForward, cs10Farewell.GrannyDisappear, cs10Farewell.FadeToWhite, cs10Farewell.WaitForGranny);
            yield return 2f;
